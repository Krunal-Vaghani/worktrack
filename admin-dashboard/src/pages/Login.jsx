  ...
  return (
    <div style={S.bg}>
      <div style={S.card}>
        ...
        <p style={S.hint}>Default: admin@company.com / admin123</p>
      </div>
    </div>
  );
}
...
const S = {
  ...
  card:     { width:360, background:'#fff', borderRadius:16, padding:32, border:'1px solid #E5E7EB', boxShadow:'0 4px 24px rgba(0,0,0,.06)' },
  ...
  input:    { padding:'10px 12px', border:'1px solid #E5E7EB', borderRadius:8, fontSize:14, outline:'none', color:'#111827', transition:'border-color .15s' },
