...
// GET /api/sync/employees — EXE fetches server employee list (sync token auth)
router.get('/employees', clientAuth, async (req, res) => {
  try {
    const result = await db.query(
      `SELECT user_id, name, role, device_id, active,
...
// DELETE /api/sync/employees/:id — EXE admin deletes employee
router.delete('/employees/:id', clientAuth, async (req, res) => {
  try {
